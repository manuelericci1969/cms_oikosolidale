(function () {
  ...
  var runtimeSrc = '/assets/admin/visual-editor-v5/runtime/background-slider-runtime.js?v=20260506-v5-bg-slider-runtime';
  var managerSrc = '/assets/admin/visual-editor-v5/background/background-manager.js?v=20260512-v5-background-manager';
  ...
  function loadManager() {
    if (window.R4V5BackgroundManager || document.getElementById('r4v5-background-manager-script')) return;
    var script = document.createElement('script');
    script.id = 'r4v5-background-manager-script';
    script.src = managerSrc;
  ...
  function initInsideFrame() {
    ...
    if (doc.defaultView.R4V5BackgroundSlider && typeof doc.defaultView.R4V5BackgroundSlider.init === 'function') {
      doc.defaultView.R4V5BackgroundSlider.init();
    }
  }
  ...
  function injectRuntime() {
    ...
    if (!doc.getElementById('r4v5-background-slider-runtime-iframe')) {
      var script = doc.createElement('script');
      script.id = 'r4v5-background-slider-runtime-iframe';
  ...
  function bindEditor() {
    loadManager();
    var ed = editor();
    if (!ed || ed.__r4v5BackgroundSliderBridge) return !!ed;
    ed.__r4v5BackgroundSliderBridge = true;
  ...
  window.R4V5BackgroundSliderBridge = {
